...
namespace WebApplication3.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(PracticeAdilaDbContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.Test = "in Index Action of Home controller testing";
            return View();
                
                /* _context.Restaurants != null ? 
                          View(await _context.Restaurants.ToListAsync()) :
                          Problem("Entity set 'PracticeAdilaDbContext.Restaurants'  is null."); */
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PracticeAdilaDbContext.Restaurants'  is null.");
            }
            var restaurant = await _context.Restaurants.FindAsync(id);
            if (restaurant != null)
            {
